...
(function () {
  ...
  function buildModuleMenuPanel() {
    ...
    panel.appendChild(buildGroup('Part I \u2014 The Parts Counter', partI));
    panel.appendChild(
      el('button', { class: 'module-menu__item module-menu__item--exam', onclick: () => goTo({ view: 'exam', part: 'I' }) }, ['Part I Exam'])
    );
    panel.appendChild(buildGroup('Part II \u2014 Accessories & the Rear Counter', partII));
    panel.appendChild(
  ...
  async function renderTOC(root, trainee) {
    ...
    page.appendChild(buildPartSection('I', 'The Parts Counter', partI, 'part1-exam', 'Part I Exam \u2014 The Parts Counter', DATA.part1Exam));
    page.appendChild(buildPartSection('II', 'Accessories & the Rear Counter', partII, 'part2-exam', 'Part II Exam \u2014 Accessories & the Rear Counter', DATA.part2Exam));
  }
  ...
  function renderQuizOrExam(root, trainee, opts) {
    ...
    if (opts.mode === 'quiz') {
      ...
      quizLabel = isOne ? 'Part I Exam \u2014 The Parts Counter' : 'Part II Exam \u2014 Accessories & the Rear Counter';
      backRoute = { view: 'toc' };
      eyebrow = `Part ${opts.part} Exam`;
      title = isOne ? 'The Parts Counter' : 'Accessories & the Rear Counter';
